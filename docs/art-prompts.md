...
| 10 | Cinderpup | Pyric | Cinderpup > Cinderbark > Cinderhowl | base | magenta | cute | F1 [x]  F2 [x]  F3 [ ] |
...
| 17 | Voltfluff | Voltaic | Voltfluff > Staticfleece > Arcwool | base | magenta | cute | F1 [x]  F2 [x]  F3 [ ] |
