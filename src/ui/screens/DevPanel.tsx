...
/**
 * Testing tools, behind the Settings toggle (plan.md 7.1). Step 1.8a ships only the fast-forward; 1.8b adds granting
 * a creature, adding resources, Aether and gold, and resetting the save.
 *
...
export function DevPanel() {
  ...
  return (
    <section className="panel" aria-label="Dev panel">
      <h2>Dev panel</h2>
      <p className="small muted">
        For testing. Everything here goes through the same actions and the same save path the game uses.
      </p>
      ...
      <p className="small muted">
        This control exists because editing <code>lastSeen</code> in localStorage by hand does not work while the tab
