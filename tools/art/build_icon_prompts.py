"""Builds godot/docs/archive/art/art-prompts-icons.md, godot/docs/archive/art/art-prompts-zones.md and D:/AI/tools/icons.json from one data
...
DOC_OUT = GODOT / "docs" / "archive" / "art" / "art-prompts-icons.md"
ZONE_DOC_OUT = GODOT / "docs" / "archive" / "art" / "art-prompts-zones.md"
...
I("stormray", "item", "Fish", "m", "A manta ray, not an ordinary fish: a wide flat diamond-shaped blue-grey body with broad pointed wing fins spreading out to the left and right, a long thin whip tail and small yellow zigzag markings on its back.", view="seen from directly above")
...
I("gloomeel-pie", "item", "Meals", "m", "A small round golden pie with a crimped pastry crust, a long thin eel shape cut from pastry lying flat on the crust in a loose coil, with no head sticking up, and a slice cut out showing a dark filling.")
...
I("stormray-chowder", "item", "Meals", "m", "A round crusty golden-brown bread loaf hollowed out as the bowl, filled with creamy pale chowder with a few green herb flecks, no dish or plate.")
...
def md():
    ...
    a("Generated by `godot/tools/art/build_icon_prompts.py` (edit the table there, rerun, and this file and `D:\\AI\\tools\\icons.json` "
      "are rebuilt). The creature sprite prompts are the separate `docs/archive/art/art-prompts.md` on `main`.\n")
    a("## What this covers\n")
    ...
    a("- **Not covered:** eggs (drawn by a shader in the game), the island battle backdrops (their own file, `docs/archive/art/art-prompts-zones.md`), and the hybrid creature sprites (those belong in the "
