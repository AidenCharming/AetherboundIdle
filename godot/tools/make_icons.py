...
UI = {'aether': ui_aether, 'gold': ui_gold, 'woodcutting': ui_axe, 'herbalism': lambda: leaf('#57cf8e', '#8fe8b4', '#2f9a62'),
      ...
      'meal': lambda: meal('#e0a36a', '#f0c49a', '#b07a42'), 'owned': ui_owned, 'market': ui_market,
      'egg-market': ui_egg_market, 'boost-incense': ui_boost_incense, 'boost-tonic': ui_boost_tonic,
